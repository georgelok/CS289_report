...
\begin{enumerate}[leftmargin=0.25cm]
	...
	\item Fully centralized collaboration of independent subteams
...
A good trapping heuristic will have to exhibit two characteristics: 1- The predators have to congregate around the prey from different directions (try to circle around it). 2- The predators have to come closer to the prey (tighten their circle around it) until they catch it. The heuristic we settled on consists of two features. The first feature pertains to the distance between the ghost and Pacman. The second feature can be described as the total number of positions that are unsafe for pacman to be in, within a radius $r$. A position is unsafe if a ghost needs only one action to get there. To illustrate this, we can look at the following two images where the blue dots represent all the safe positions for Pacman within radius 4 and the red dots represent all the unsafe positions within radius 4. In figure 2, the ghosts are close to each other so they only make seven dots unsafe. In figure 3, the ghosts are trapping pacman and they make 15 dots unsafe.\\ 
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.35]{maptogether.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.35]{mapcorners.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.3]{StigmergyClassic1.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.3]{StigmergyClassic2.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.6]{leftsteps.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.6]{cornersteps.png}
...
\begin{figure}[H]
\begin{center}
	\includegraphics[scale=0.5]{stigmergytrendclassicscore.png}
	\includegraphics[scale=0.5]{stigmergytrendclassicfail.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=0.5]{stigmergytrendaltscore.png}
	\includegraphics[scale=0.5]{stigmergytrendaltfail.png}
